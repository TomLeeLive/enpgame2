...
public class TAutoFade : MonoBehaviour
{
    private static TAutoFade m_Instance = null;
    private Material m_Material;
    private string m_LevelName = "";
    private int m_LevelIndex = 0;
    private bool m_Fading = false;
    private static TAutoFade Instance
    {
        get
        {
            if (m_Instance == null)
            {
                m_Instance = (new GameObject("TAutoFade")).AddComponent<TAutoFade>();
            }
            return m_Instance;
        }
    }
